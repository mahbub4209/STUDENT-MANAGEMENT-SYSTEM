...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email Id","Class X(%)","Class XII(%)","Village Address","ID","Course","Branch"};
    ...
    StudentDetails(){
       ...
       try{
           ...
           while(rs.next()){
               ...
               y[i][j++] = rs.getString("fathr's_name");
               ...
               y[i][j++] = rs.getString("village_address");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
            String a = t2.getText();
            String q = "delete from student where idno = '"+a+"' ";
