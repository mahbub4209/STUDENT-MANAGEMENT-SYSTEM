...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    public StudentFeeForm(){
        ...
        c1.setFont(new Font("Trebucht MS",Font.BOLD,14));
        ...
        try{
            ...
            while(rs.next()){
               c1.add(rs.getString("iddno"));
               
            }
        }catch (Exception e){}
        
        JLabel l1 = new JLabel("Select Id No");
        l1.setForeground(new Color(25,25,112));
        l1.setFont (new Font("Tahma",Font.BOLD,14));
        l1.setBounds(64,63,102,22);
        contentPane.add(l1);
        
        JLabel l2 = new JLabel("Name");
        l2.setForeground(new Color(25,25,112));
        l2.setFont (new Font("Tahma",Font.BOLD,14));
        l2.setBounds(64,97,102,22);
        contentPane.add(l2);
        
        JLabel l3 = new JLabel("Father's Name");
        l3.setForeground(new Color(25,25,112));
        l3.setFont (new Font("Tahma",Font.BOLD,14));
        l3.setBounds(64,130,102,22);
        contentPane.add(l3);
        
        JLabel l4 = new JLabel("Branch");
        l4.setForeground(new Color(25,25,112));
        l4.setFont (new Font("Tahma",Font.BOLD,14));
        l4.setBounds(64,209,102,22);
        contentPane.add(l4);
        
        JLabel l5 = new JLabel("Semester");
        l5.setForeground(new Color(25,25,112));
        l5.setFont (new Font("Tahma",Font.BOLD,14));
        l5.setBounds(64,242,102,22);
        contentPane.add(l5);
        
        JLabel l6 = new JLabel("Total Payable");
        l6.setForeground(new Color(25,25,112));
        l6.setFont (new Font("Tahma",Font.BOLD,14));
        l6.setBounds(64,275,102,22);
        contentPane.add(l6);
        
        c1.setBounds(174,66,152,20);
        contentPane.add(c1);
        
        t2 = new JTextField();
        t2.setForeground(new Color(47,79,79));
        t2.setFont(new Font("Trebucht MS",Font.BOLD,14));
        t2.setColumns(10);
        ...
        t3.setFont(new Font("Trebucht MS",Font.BOLD,14));
        t3.setColumns(10);
        ...
        try{
            ConnectionClass c = new ConnectionClass();
            ResultSet rs = c.s.executeQuery("select * from student where idno = '"+c1.getSelectedItem()+"'");
            while(rs.next()){
               t2.setText(rs.getString("name"));
               t3.setText(rs.getString("father's_name"));
            }
        
        }catch (Exception e){}
        
        comboBox = new JComboBox();
        comboBox.setModel(new DefaultComboBoxModel(new String[]{"CSE","IT","EEE","ECE","Civil"}));
        ...
        t1.setFont(new Font("Trebucht MS",Font.BOLD,14));
        t1.setColumns(10);
        ...
        b1.setFont(new Font("Trebucht MS",Font.BOLD,14));
        ...
        b2.setFont(new Font("Trebucht MS",Font.BOLD,14));
        ...
        l7.setFont (new Font("Tahma",Font.BOLD,14));
        l7.setBounds(64,173,102,22);
        contentPane.add(l7); 
        
        comboBox_3 = new JComboBox();
        comboBox_3.setModel(new DefaultComboBoxModel(new String[]{"Bsc","BBA","BA","Msc","MBA"}));
        ...
        try{
            if(ae.getSource() != b1){
                ...
                try{
                    ...
                    String sql = "insert into fee(idno,name,father's_name,course,branch,semester,fee_paid) values (?,?,?,?,?,?,?)";
