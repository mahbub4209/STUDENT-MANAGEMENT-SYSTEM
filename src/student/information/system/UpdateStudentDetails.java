...
import java.sql.*;
 ...
 class UpdateStudentDetails implements ActionListener{
    ...
    UpdateStudentDetails(){
        ...
        id11 = new JLabel("Village Address");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
          try{
              ...
              String str = "update student set name = ('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+k+"','"+l+"','"+m+"')";
        ...
        if(ae.getSource() == b2){
             try{
              ConnectionClass con = new ConnectionClass();
              String str = "select * from student where idno = '"+t12.getText()+"' ";
